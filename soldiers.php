...
<tr>
	<td class="mwitu1">
	<a href ="soldiers1.php?names=<?php echo $name; ?>&id=<?php echo $id; ?>"><?php echo $id; ?></a>
	</td> 
...
echo "<a href= 'soldiers.php?page=$prev'>Prev</a>&nbsp";
...
if($page<$pages){
echo "<a href= 'soldiers.php?page=$next'>Next</a>";
}
	echo "</center>";
